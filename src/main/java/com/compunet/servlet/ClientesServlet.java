...
public class ClientesServlet extends HttpServlet {
    ...
    private void readClientes(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            while (r.next()) {
                tabla += "<tr>";
                tabla += "<td>" + r.getInt("idCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("ciCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("numeroDeCuentaCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("saldoCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("nombreCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("apellidoCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("direccionCli");
                tabla += "</td>";
                tabla += "<td>" + r.getString("telefonoCli");
                tabla += "</td>";
                tabla += "<td>";
